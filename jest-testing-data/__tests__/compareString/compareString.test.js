import * as column from '../../data/compareString/compareString'
...
describe('Testing fungsi penambahan', () => {
    beforeAll(async () => {
        // File String Data
        stringDataTarget = txtToJson({ filePath: "./data/compareString/compareStringTarget.txt" });
        stringDataTarget = base.addCombinedKey(stringDataTarget);
        console.log(stringDataTarget);

        // Comparison File String Data 
        stringDataPembanding = txtToJson({ filePath: "./data/compareString/compareStringPembanding.txt" });
